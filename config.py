...
BATTERY_CAPACITY_KWH = _env_float("BATTERY_CAPACITY_KWH", 60.0)
...
WHATSAPP_RECIPIENTS = _parse_recipients(_env("WHATSAPP_RECIPIENTS", "+57YOUR_NUMBER"))

TRIP_POLL_SECONDS = _env_int("TRIP_POLL_SECONDS", 45)

CHARGE_LOW_PERCENT = _env_int("CHARGE_LOW_PERCENT", 35)
CHARGE_REMINDER_TARGET = _env_int("CHARGE_REMINDER_TARGET", 100)
